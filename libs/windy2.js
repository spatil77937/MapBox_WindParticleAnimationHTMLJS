...
var Windy = function (params) {
    var VELOCITY_SCALE = 0.030;             // scale for wind velocity (completely arbitrary--this value looks nice)
    ...
    var createBuilder = function (data) {
      ...
      data.forEach(function (record) {
        switch (record.header.component) {
          case "u": uComp = record; break;
          case "v": vComp = record; break;
          default:
            scalar = record;
        }
      });
    ...
    var buildGrid = function (data, callback) {
      ...
      var date = new Date(header.forecastTime);
